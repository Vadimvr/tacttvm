...
using IconInTheTaskbar.Platform.Win.Interop;

namespace IconInTheTaskbar.Platform.Win
{
    /// <summary>
            ...
            set
            {
                try
                {
                    ...
                    if (value.StartsWith("resm:"))
                    {
                        ...
                        _icon = new System.Drawing.Icon(assets.Open(new Uri(value)));

                    }
                    else
                    {
                        // File system path
                        _icon = new System.Drawing.Icon(value);
                    }
                    _iconPath = value;
                }
                catch (Exception)
